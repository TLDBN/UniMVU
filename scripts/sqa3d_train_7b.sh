...
deepspeed --master_port 60000 train.py \
    ...
    --model_type unimvu \
    --output_dir ./checkpoints/unimvu_sqa3d_7b \
...
CUDA_VISIBLE_DEVICES=0 python unified_eval.py \
    --dataset sqa3d \
    --model-path ./checkpoints/unimvu_sqa3d_7b \
    ...
    --pred-save /share_1/users/bonan_ding/PAVE_data/data/video_instruction_tuning/prediction/unimvu_sqa3d_7b.json \
...
python tools/3d/sqa3d/sqa3d_evaluator.py \
    ...
    --results-file /share_1/users/bonan_ding/PAVE_data/data/video_instruction_tuning/prediction/unimvu_sqa3d_7b.json
