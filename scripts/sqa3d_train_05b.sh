...
deepspeed --master_port 60000 train.py \
    ...
    --annotation_path /share_1/users/bonan_ding/PAVE_data/data/video_instruction_tuning/scannet/sqa3q_ScanQA_format/SQA_train_instruct.json \
    ...
    --model_type unimvu \
    --output_dir ./checkpoints/unimvu_sqa3d_05b \
...
CUDA_VISIBLE_DEVICES=0 python unified_eval.py \
    --dataset sqa3d \
    --model-path ./checkpoints/unimvu_sqa3d_05b \
    --model-base lmms-lab/llava-onevision-qwen2-0.5b-ov \
    --model-arg-name VideoFeatModelArgumentsUniMVU \
    --model-type unimvu \
    --question-file /share_1/users/bonan_ding/PAVE_data/data/video_instruction_tuning/scannet/sqa3q_ScanQA_format/llava3d_sqa3d_test_question.json \
    ...
    --pred-save /share_1/users/bonan_ding/PAVE_data/data/video_instruction_tuning/prediction/unimvu_sqa3d_05b.json \
...
python tools/3d/sqa3d/sqa3d_evaluator.py \
    --gt-file /share_1/users/bonan_ding/PAVE_data/data/video_instruction_tuning/scannet/sqa3q_ScanQA_format/llava3d_sqa3d_test_answer.json \
    --results-file /share_1/users/bonan_ding/PAVE_data/data/video_instruction_tuning/prediction/unimvu_sqa3d_05b.json
