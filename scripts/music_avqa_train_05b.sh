...
deepspeed --master_port 60000 train.py \
    ...
    --model_type unimvu \
    --output_dir ./checkpoints/unimvu_music_avqa_05b \
...
CUDA_VISIBLE_DEVICES=0 python unified_eval.py \
    --dataset music_avqa \
    --model-path ./checkpoints/unimvu_music_avqa_05b \
    ...
    --pred-save /share_1/users/bonan_ding/PAVE_data/data/video_instruction_tuning/prediction/unimvu_music_avqa_05b.json \
...
python tools/audio/music-avqa/calculate_acc.py \
    --prediction-path /share_1/users/bonan_ding/PAVE_data/data/video_instruction_tuning/prediction/unimvu_music_avqa_05b.json \
