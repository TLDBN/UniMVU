...
deepspeed --master_port 60000 train.py \
    ...
    --model_type unimvu \
    --output_dir ./checkpoints/unimvu_scanqa_7b \
...
CUDA_VISIBLE_DEVICES=0 python unified_eval.py \
    --dataset scanqa \
    --model-path ./checkpoints/unimvu_scanqa_7b \
    ...
    --pred-save /share_1/users/bonan_ding/PAVE_data/data/video_instruction_tuning/prediction/unimvu_scanqa_7b.json \
...
python tools/3d/scanqa/scanqa_evaluator.py \
    ...
    --results-file /share_1/users/bonan_ding/PAVE_data/data/video_instruction_tuning/prediction/unimvu_scanqa_7b.json
